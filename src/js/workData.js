module.exports = {
	bricks: {
		...
		description: 'Bricks allows you to take a group of images that are all different dimensions and fit them into a grid without distorting the aspect ratio of the image. This type of image layout is commonly seen on Google Images and Flickr, my aim was to create a plugin with no dependencies and enough options to be able to fit into any project.',
		...
		process:[
			...
			'<p>I like to use new projects as opportunities to learn at least one new thing, for Bricks it was ECMAScript 6. I had played around with ES6 a little here and there but never really got into it properly and this was as good a time as any. As far as other tech goes I used Gulp as my task-runner because I am very comfortable with it and it does what I need it to (compiling ES6 to ES5, SCSS to CSS, etc..).</p>',
	...
	abby: {
		...
		process: [
			'<h3 class="u-heading-6">01. Research</h3>',
			'<p>Before getting to far into this project I looked at other CSS frameworks I had used in the past to see what I liked about them and what I disliked. One of my main influences behind Abby was the famous Skeleton boilerplate, it only provides the bare essentials which I like, but you cannnot customize it with SCSS would make it great. I did not what to create a UI framework because each project has a different styles UI, and if I need to prototype something quick I can just use one of the many UI frameworks out there already. I also wanted the class naming to follow BEMIT since it&#39;s one of the most powerful concepts in CSS and makes naming things so much easier and logical.</p>',
	...
	readit: {
		...
		process: [
			...
			'<h3 class="u-heading-6">02. Node</h3>',
	...
	socialcircles: {
		...
		process: [
			...
			'<p>The concept of state is not anything new, but I did enjoy the way React manages state. In this app there is not much state to manage, just the name of the active social network, total users of the network, and the list of countries. When a button is clicked the state is updated and the DOM elements gets updated with the new state right after.</p>',
			'<h3 class="u-heading-6">HTML in JS</h3>',
			'<p>Another thing I liked in React was JSX, the idea of writing HTML inside of your JavaScript seemed a bit odd at first but it is actually helpful when developing a JavaScript app. I did not implement anything as complex as JSX but I did render the HTML of the app within an ES6 template string made things really clean and easy to manage.'
		].join('')
	}
};