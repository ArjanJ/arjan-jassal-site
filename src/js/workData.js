module.exports = {
	...
	readit: {
		...
		process: [
			...
			'<p>After hearing so much about React I had to learn it. Coming from Angular, learing React had a larger learning curve since it is so fundamentally different to Angular. I decided to buy <a href="https://reactforbeginners.com/" target="_blank" class="work-details__link">The React for Beginners</a> course to see how to structure a React app, how to handle data, update state, pass props, and of course routing. At first I kept comparing my experience to Angular and thinking that the Angular way of doing things was better. As the course grew closer to an end I started liking React a lot more and seeing the benefits of JSX, one-way data flow, and components that fit together like building blocks in an app. It is also nice that React forces you to write a lot of good JavaScript which is great since it helped me learn more about JS which is always good.</p>',
